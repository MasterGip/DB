 ...
 */
public class ListOfAbiturients extends JFrame {

    ListOfAbiturients(ArrayList<ArrayList<String>> listOfAbiturients){
        super();
        ...
        if(listOfAbiturients!=null){
            ...
            JPanel panelOfAbiturient = new JPanel(new GridLayout(1, 5));
            ...
            for(int i = 0; i < listOfAbiturients.size(); i++){
                ...
                box.setSelected((listOfAbiturients.get(i).get(4).equals("true"))?true:false);
                box.setEnabled(false);
                panelOfAbiturient.add(box);
                g_l.setConstraints(panelOfAbiturient, c);
                panel.add(panelOfAbiturient);
            }
